...
$sql = "INSERT INTO registro_pendiente_usuarios (nombre, dni, fecha_nacimiento, correo, clave, telefono, direccion, token)
        VALUES ('$nombre', '$dni', '$fecha_nacimiento', '$correo', '$clave', '$telefono', '$direccion', '$token')";
